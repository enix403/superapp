...
export default function CourseView() {
  ...
  const handleTeacherClick = () => {
    if (course) alert(`Navigating to ${course.teacher.name}'s profile page`);
  };
      ...
      <div className='grid grid-cols-1 gap-6'>
        {selectedVideo && (
          <div className='mb-8'>
            ...
            <h3 className='mb-2 text-lg font-medium'>{selectedVideo.title}</h3>
      ...
      <div className='flex items-center justify-between rounded-xl bg-gray-50 p-6'>
        <div>
          ...
          <p className='text-gray-600'>
            Join {course.enrollments} students already enrolled
          </p>
        </div>
