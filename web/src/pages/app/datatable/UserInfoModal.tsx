...
import { cn, ParamVoidCallback, VoidCallback } from "@/lib/utils";
...
function UserEditInfoModal({
  user,
  setOpen
}: {
  user: any;
  setOpen: ParamVoidCallback<boolean>;
}) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='contents'>
        <UserInfoFormFields />
        <UserInfoModalFooter isSubmitPending={updateUserMutation.isPending} />
      </form>
    </Form>
  );
}
